function out = flim2hist()
% FLIM2HIST()
% flim2hist() lets the user open an ASC color-coded image output from the
% FLIM B&H software and select rectangular ROIs to then further analyze
% individually
